// fetch CMS data
import { env, apiFetch } from './util.js';
...
export async function cmsFetch() {
  ...
  const
    ...
    postFields = 'fields[]=status,date,organization,post_type,topic_type,topic_spotlight,index_post,feature_post,show_image,show_description,show_related,title,slug,description,content,tags,author,source,source_url,image.id,image.title,image.width,image.height,image_small.id,image_small.width,image_small.height',
    postSort = 'sort[]=-date';
